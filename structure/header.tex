...
\hypersetup{pdfauthor={Markus Hiesmair},
    pdftitle={Drive-by Parking Space Detection Based on Machine Learning},
...
\setlength{\headheight}{22mm} \setlength{\headsep}{10mm}
\setlength{\textheight}{233mm} \setlength{\textwidth}{143mm}
