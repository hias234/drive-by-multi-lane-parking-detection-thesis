...
% two-staged classification process
\begin{table}
...
\caption{Confusion Matrix of the best found configuration of the implemented two-staged classification technique (see Section \ref{sec:improv_classification_surrounding_segments}) with two random forests and using 10 surrounding samples applied on the filtered dataset.}
\label{table:cf_tsp}
\end{table}