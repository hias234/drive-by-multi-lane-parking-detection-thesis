...
%\end{center}
%
%\caption{Confusion matrices of a \textbf{\textit{dense deep neural network}} (5 layers with 50 units each, trained in 200 epochs, using raw distance measurements as input) applied on (a) the full dataset and (b) the filtered dataset.}
%\label{table:cf_dnn}
%\end{table}
...
\caption{Confusion matrices of a \textbf{\textit{dense deep neural network with 10\% dropout}} (5 layers with 50 units each, trained in 200 epochs, using raw distance measurements as input) applied on (a) the full dataset and (b) the filtered dataset.}
