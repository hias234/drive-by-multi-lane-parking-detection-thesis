...
Finally, the use of parking space maps to improve classification results and acquiring these parking space maps is described in Section \ref{sec:parking_space_maps}.\todo{rewrite :)}
...
Especially the precision and recall values of the "parking car" class are of interest, because detecting parking cars is crucial for creating highly accurate parking space availability maps.
