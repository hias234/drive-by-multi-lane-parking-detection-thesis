...
After data preprocessing, data segmentation and feature calculation have been performed, the final dataset which is being used for the further machine learning is available. The dataset is made up of samples with all feature values described in the previous section and the corresponding class label. The dataset consists of 14.303 samples in total which are composed of 11.811 free spaces, 2.216 parking cars, 207 overtaking situations and 69 other parking vehicles. 
...
The overall goal of machine learning experiments 
in this case 
is to find the feature subset and the machine learning model which in combination produce the highest accuracy in classifying all segments. 
