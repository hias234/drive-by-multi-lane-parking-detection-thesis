...
After the data segmentation and the feature calculation have been performed, the final dataset which is being used for the further machine learning is available. The dataset is made up of samples (or segments) with all feature values described in the previous section and the corresponding class label. The dataset consists of 11.811 free spaces, 2.216 parking cars, 207 overtaking situations and 69 other parking vehicles. 
