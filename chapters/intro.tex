...
To determine if it is possible to derive parking availability statistics from drive-by sensing in complex road scenarios several steps have to be taken. The used research methodology can be shown with the following steps:
