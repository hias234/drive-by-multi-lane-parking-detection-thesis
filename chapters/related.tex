...
\hline
  ...
  & \cite{Ma:2014:USP:2674918.2674929} 89\% & & - drains battery of the user's smartphones \\
...
\hline
  \textbf{Viola-Jones feature-based} & \cite{Grassi:2017:PIE:3132211.3134452} 90\% & \\
  \textbf{ cascade classifier} & & \\
  (camera-based drive-by sensing) &  & \\
\hline
  \textbf{Random Forest Classifier} & \cite{Bock2015} 96\% & 1.313 parking cars and 1.306 other objects \\
  (2D distance sensor based drive-by sensing) &  & \\
\hline
