...
\hline
  ...
  \cite{Amato2016} 91\% & \cite{Amato2016} about 700.000 images \\
  (Stationary cameras) & \cite{DiMauro2016} 96\% & \cite{DiMauro2016} about 970.000 images \\
\hline
  \textbf{Viola-Jones feature-based} & \cite{Grassi:2017:PIE:3132211.3134452} 90\% & 5.896 parked cars and \\
  \textbf{ cascade classifier} & & 2.280 available
parking spaces \\
  (camera-based drive-by sensing) &  & \\
\hline
  \textbf{Random Forest Classifier} & \cite{Bock2015} 96\% & 1.313 parking cars and  \\
