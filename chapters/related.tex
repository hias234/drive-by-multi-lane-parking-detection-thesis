...
\hline
   & \textbf{Accuracy} & \textbf{Costs} & \textbf{Applied on} & \textbf{Applied on} \\
   & & \textbf{per} & \textbf{parking lots or} & \textbf{road side} \\
   & & \textbf{sensor} & \textbf{parking garages} & \textbf{parking} \\
%\hline
\hline
...
\hline
  ...
  yes \tikz\draw[green,fill=green] (0,0) circle (.5ex); & 
  yes \tikz\draw[green,fill=green] (0,0) circle (.5ex); \\
  & \cite{Ma:2014:USP:2674918.2674929} 89\% & & & \\
