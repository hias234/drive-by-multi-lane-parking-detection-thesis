...
\hline
  ...
  \cite{Blumer2012} 88.8\% & 
  about \$85 & 
  - Cameras can only cover limited area \\
  & \cite{Amato2016} 91\% & & - A lot of cameras needed for \\
  & \cite{DiMauro2016} 96\% & & city-wide deployments \\
  & & & - affected by lightning and occlusions \\
\hline
  \textbf{Counting Vehicles} &
  \cite{smarturbanparkingdetection} 100\% & 
  about \$45 & 
  - hardly applicable in open street scenarios \\
  & & & - gates needed for in- and outgoing vehicles \\
\hline
  \textbf{Event-based Sensing} & 
  \cite{Nawaz:2013:PSB:2500423.2500438} 85\% & 
  \$0 & 
  - high user base required (crowd sensing) \\
  & \cite{Ma:2014:USP:2674918.2674929} 89\% & & - battery usage of user's smartphones \\
  & \cite{Nandugudi:2014:PPP:2632048.2632098} 94\% & & \\
\hline
  \textbf{Drive-by Sensing} & 
  \cite{Grassi:2017:PIE:3132211.3134452} 90\% & 
  \$0 & 
  - high user base required (crowd sensing) \\
  \textbf{(Camera)} & & & - detection of different types of parking cars  \\
  & & & - multi lane and overtaking situations \\
  & & & - traffic lights and traffic jams \\
  & & & - avoiding multiple detections of the same car \\
\hline
  \textbf{Drive-by Sensing} & 
  \cite{Mathur:2010:PDS:1814433.1814448} 93\% & 
  about \$400 & 
  - detection of different types of parking cars \\
  \textbf{(1D-Distance sensor)} & & & - multi lane and overtaking situations \\
  & & & - traffic lights and traffic jams \\
\hline
\textbf{Drive-by Sensing} & 
  \cite{Bock2015} 96\% & 
  \$1000 - \$5000 & 
   - detection of different types of parking cars \\
  \textbf{(2D-Distance sensor)} & & & - multi lane and overtaking situations \\
  & & & - traffic lights and traffic jams \\
\hline
...
\paragraph{Comparison of Machine Learning approaches}

Table \ref{table:comparison_ml_approaches} shows an overview of all machine learning algorithms which were used for the classification of parking situations in cities. 
...
\hline
  ...
  \cite{Amato2016} 91\% & \\
  (Stationary cameras) & \cite{DiMauro2016} 96\% & \\
\hline
  \textbf{Viola-Jones feature-based cascade classifier} & 
  \cite{Grassi:2017:PIE:3132211.3134452} 90\% & \\
...
\caption{Comparison of machine learning approaches to detect a city's parking space availability}
