...
The bad results on the two classes is probably cased because there are really few segments of both classes available in the datasets, thus the variety of the data is low and a lot of different cases are not included in the segments which have been sensed. Another explanation is again the the imbalance in both datasets.
