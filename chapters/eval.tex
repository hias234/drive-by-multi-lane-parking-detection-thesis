...
As mentioned in earlier sections, the datasets consists of three different types of parking cars: Parallel parking cars, perpendicular parking cars and angular parking cars. All of these different types of parking cars are included in the broader \emph{parking car}-class which gets predicted by the classifiers. In this section the performance of the classification on the different types of cars is being investigated.
