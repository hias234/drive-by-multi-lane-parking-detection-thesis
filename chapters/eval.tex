...
%In absolute numbers this means that 31 parking cars are detected which have been missed by the normal random forest classifier. 



%Table \ref{table:surrounding_classifier_confusion_matrix} shows the detailed 
