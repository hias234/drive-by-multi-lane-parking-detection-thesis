...
Another promising option to sense a city's parking situation is the use of mobile sensors instead of static ones. This approach has the advantage to be usually more cost effective and can provide sufficient accuracy.
