...
Another option to sensing a city's parking situation is the use of mobile instead of static sensors. For instance, Mathur et al. \cite{Mathur:2010:PDS:1814433.1814448} developed their system "ParkNet" which could sense parking spaces using an ultrasonic range finder which was mounted on the co-driver's side of the car. The sensor measured the distance to the nearest obstacle on the right side of the road (in many cases a parking car). Using this information and GPS measurements they could derive the parking space counts and the parking occupancy rates by an accuracy of over 90\%.
