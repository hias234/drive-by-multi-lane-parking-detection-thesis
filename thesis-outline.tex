...
%The aim of this thesis is to implement a prototype which is able to detect parking space counts and parking occupancy rates of road side parking in cities. 
%One solution to make the current parking situation more transparent is to put sensors to every parking space in the city, which check, if the corresponding parking space is occupied or vacant. This, however, has the drawback to be very expensive and inefficient since the rate at which the parking situation changes is fairly infrequent.
